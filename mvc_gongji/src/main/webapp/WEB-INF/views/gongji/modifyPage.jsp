...
<div class="container">
	...
	<br>
	<form name="modify" action="modifyPage" method="POST">
		...
		<div class="btn-group float-right">
			<button type="button" class="btn btn-primary" id="btnList" onclick="location.href='${path}/gongji/listPage?page=${cri.page}&perPageNum=${cri.perPageNum}'">취소</button>
